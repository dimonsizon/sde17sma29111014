$(function() {
    ...
    function it(n) {
        if (t.beginPath(), t.globalAlpha = 1, t.moveTo(411, 158), t.lineTo(545, 158), t.quadraticCurveTo(590, 158, 590, 203), t.lineTo(590, 582), t.quadraticCurveTo(590, 627, 545, 627), t.lineTo(411, 627), t.quadraticCurveTo(366, 627, 366, 582), t.lineTo(366, 203), t.quadraticCurveTo(366, 158, 411, 158), t.lineWidth = 1, t.strokeStyle = "#f5f5f5", t.fillStyle = "#f5f5f5", t.fill(), t.stroke(), t.closePath(), n)
            for (i = u.length - 1; i < u.length; i++) {
                var r = u[i];
                r.cx = r.imageX + (r.imageRight - r.imageX) / 2, r.cy = r.imageY + (r.imageBottom - r.imageY) / 2, t.save(), t.translate(r.cx, r.cy), t.rotate(r.rotate), t.globalCompositeOperation = "source-atop", t.globalAlpha = 1, t.drawImage(r.img, 0, 0, r.img.width, r.img.height, -r.imageWidth / 2, -r.imageHeight / 2, r.imageRight - r.imageX, r.imageBottom - r.imageY), t.restore()
            }
        t.drawImage(w, 278, 111, 400, 563), t.save(), t.beginPath(), t.globalAlpha = 1, t.moveTo(411, 158), t.lineTo(545, 158), t.quadraticCurveTo(590, 158, 590, 203), t.lineTo(590, 582), t.quadraticCurveTo(590, 627, 545, 627), t.lineTo(411, 627), t.quadraticCurveTo(366, 627, 366, 582), t.lineTo(366, 203), t.quadraticCurveTo(366, 158, 411, 158), t.shadowColor = "#757677", t.shadowBlur = 30, t.globalCompositeOperation = "destination-over", t.fill(), t.closePath(), t.restore()
    }

    function k(n, r) {
        if (t.beginPath(), t.globalAlpha = 1, t.moveTo(371, 121), t.lineTo(385, 121), t.quadraticCurveTo(390, 121, 390, 131), t.quadraticCurveTo(390, 146, 405, 146), t.lineTo(437, 146), t.quadraticCurveTo(452, 146, 452, 131), t.quadraticCurveTo(452, 121, 457, 121), t.lineTo(585, 121), t.quadraticCurveTo(627, 121, 627, 163), t.lineTo(627, 188), t.quadraticCurveTo(627, 193, 617, 193), t.quadraticCurveTo(602, 193, 602, 208), t.lineTo(602, 308), t.quadraticCurveTo(602, 323, 617, 323), t.quadraticCurveTo(627, 323, 627, 328), t.lineTo(627, 623), t.quadraticCurveTo(627, 665, 585, 665), t.lineTo(568, 665), t.quadraticCurveTo(563, 665, 563, 655), t.quadraticCurveTo(563, 640, 548, 640), t.lineTo(408, 640), t.quadraticCurveTo(393, 640, 393, 655), t.quadraticCurveTo(393, 665, 388, 665), t.lineTo(371, 665), t.quadraticCurveTo(329, 665, 329, 623), t.lineTo(329, 163), t.quadraticCurveTo(329, 121, 371, 121), t.lineWidth = 1, t.strokeStyle = v, t.stroke(), t.fillStyle = v, t.fill(), t.stroke(), t.closePath(), t.beginPath(), t.lineWidth = 1, t.globalCompositeOperation = "destination-out", t.moveTo(399, 171), t.lineTo(425, 171), t.quadraticCurveTo(450, 171, 450, 192), t.quadraticCurveTo(450, 213, 425, 213), t.lineTo(399, 213), t.quadraticCurveTo(374, 213, 374, 192), t.quadraticCurveTo(374, 171, 399, 171), t.strokeStyle = "#ff00ff", t.stroke(), t.fill(), t.globalAlpha = 1, t.closePath(), n)
            for (i = u.length - 1; i < u.length; i++) {
                var f = u[i];
                f.cx = f.imageX + (f.imageRight - f.imageX) / 2, f.cy = f.imageY + (f.imageBottom - f.imageY) / 2, t.save(), t.translate(f.cx, f.cy), t.rotate(f.rotate), t.globalCompositeOperation = "source-atop", t.globalAlpha = 1, t.drawImage(f.img, 0, 0, f.img.width, f.img.height, -f.imageWidth / 2, -f.imageHeight / 2, f.imageRight - f.imageX, f.imageBottom - f.imageY), t.restore(), r || (t.save(), t.translate(f.cx, f.cy), t.rotate(f.rotate), t.globalCompositeOperation = "destination-over", t.globalAlpha = .2, t.drawImage(f.img, 0, 0, f.img.width, f.img.height, -f.imageWidth / 2, -f.imageHeight / 2, f.imageRight - f.imageX, f.imageBottom - f.imageY), t.restore())
            }
        t.beginPath(), t.globalCompositeOperation = "source-over", t.globalAlpha = 1, t.moveTo(411, 158), t.lineTo(545, 158), t.quadraticCurveTo(590, 158, 590, 203), t.lineTo(590, 582), t.quadraticCurveTo(590, 627, 545, 627), t.lineTo(411, 627), t.quadraticCurveTo(366, 627, 366, 582), t.lineTo(366, 203), t.quadraticCurveTo(366, 158, 411, 158), t.lineWidth = 2, t.strokeStyle = "#ff00ff", t.stroke(), t.closePath(), t.beginPath(), t.globalCompositeOperation = "source-over", t.globalAlpha = 1, t.moveTo(371, 121), t.lineTo(385, 121), t.quadraticCurveTo(390, 121, 390, 131), t.quadraticCurveTo(390, 146, 405, 146), t.lineTo(437, 146), t.quadraticCurveTo(452, 146, 452, 131), t.quadraticCurveTo(452, 121, 457, 121), t.lineTo(585, 121), t.quadraticCurveTo(627, 121, 627, 163), t.lineTo(627, 188), t.quadraticCurveTo(627, 193, 617, 193), t.quadraticCurveTo(602, 193, 602, 208), t.lineTo(602, 308), t.quadraticCurveTo(602, 323, 617, 323), t.quadraticCurveTo(627, 323, 627, 328), t.lineTo(627, 623), t.quadraticCurveTo(627, 665, 585, 665), t.lineTo(568, 665), t.quadraticCurveTo(563, 665, 563, 655), t.quadraticCurveTo(563, 640, 548, 640), t.lineTo(408, 640), t.quadraticCurveTo(393, 640, 393, 655), t.quadraticCurveTo(393, 665, 388, 665), t.lineTo(371, 665), t.quadraticCurveTo(329, 665, 329, 623), t.lineTo(329, 163), t.quadraticCurveTo(329, 121, 371, 121), t.lineWidth = 2, t.strokeStyle = "#0096ff", t.stroke(), t.closePath(), t.beginPath(), t.globalAlpha = 1, t.lineWidth = 2, t.globalCompositeOperation = "source-over", t.moveTo(399, 171), t.lineTo(425, 171), t.quadraticCurveTo(450, 171, 450, 192), t.quadraticCurveTo(450, 213, 425, 213), t.lineTo(399, 213), t.quadraticCurveTo(374, 213, 374, 192), t.quadraticCurveTo(374, 171, 399, 171), t.strokeStyle = "#ff00ff", t.stroke(), t.closePath()
    }
