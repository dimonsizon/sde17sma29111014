...
if ($_POST) { // если передан массив POST
    ...
    if (!$name or !$email or !$skype or !$message) { // если хоть одно поле оказалось пустым
    ...
    $emailgo->to_email= 'dmitry.sizon@gmail.com'; // кому
    $emailgo->to_name= 'Sizon Dmitry';
    $emailgo->subject= 'Заявка на PulsoDream'; // тема
	$emailgo->skype= $skype;
	$emailgo->skype= $phone;
    $emailgo->body= "Skype:".$skype."\nPhone:".$phone."\nMessage:".$message; // сообщение
